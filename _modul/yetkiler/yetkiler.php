            ...
            <div class="card card-success card-tabs">
              <div class="card-header p-0 pt-1">
                <ul class="nav nav-tabs"  id="yetkiSekmeler" role="tablist">
					...
					<!--li class="nav-item">
						<a class="nav-link <?php if( $aktif_tab_id == 'rol_sube_yetkileri' ) echo 'active'; ?>" id="genel-tab" data-toggle="tab" href="#rol_sube_yetkileri" role="tab" aria-controls="genel" aria-selected="false"><b>Şube Yetkileri</b></a>
					</li-->
					<!--li class="nav-item">
              ...
              <div class="card-body">
                <div class="tab-content" id="custom-tabs-one-tabContent">
					...
					<div class="tab-pane <?php if( $aktif_tab_id == 'rol_sube_yetkileri' )	echo 'active'; else echo 'pane'; ?>" id="rol_sube_yetkileri" role="tabpanel" aria-labelledby="ekle-tab">
					<div class="row">
						<div class="col-md-4">
								...
								<div class="card-body">
									<table class="table table-bordered table-hover">
										<tr>
											<th  style="width: 15px">#</th>
											<th>Adı</th>
											<th style="width: 40px">Şubeler</th>
										</tr>
										<?php $sayi = 1; foreach( $roller[ 2 ] AS $rol ) { ?>
										<tr>
											<td><?php echo $sayi++; ?></td>
											...
											<?php 
													/* Varsayılan rol düzenlenemesin */
												if( $rol[ 'varsayilan' ] * 1 == 0 ) { ?>
												<a modul= 'yetkiler' yetki_islem="duzenle" class = "btn btn-sm btn-primary btn-xs" href = "?modul=yetkiler&aktif_tab_id=rol_sube_yetkileri&rol_adi=<?php echo $rol[ 'adi' ]; ?>&rol_id=<?php echo $rol[ 'id' ]; ?>" >
													Yetkili Şubeler
												</a>
											<?php } ?>
											</td>
						...
						<div class="col-md-4">
							<div class="card card-secondary">
								<div class="card-header with-border">
									<h3 class="card-title">Rol'ün yetkili olduğu şubeler</h3>
								</div>
								<form class="form-horizontal" id = "kayit_formu" action = "_modul/yetkiler/rolSubeYetkiAtama.php" method = "POST">
								<div class="card-body">
									<h3 ><?php echo $_REQUEST[ 'rol_adi' ]; ?></h3><br>
								...
								<div class="card-body">
									<table class="table table-bordered table-hover">
										<tr>
											<th  style="width: 15px">#</th>
											<th>Adı</th>
											<th style="width: 40px">subeler</th>
										</tr>
										<?php $sayi = 1; foreach( $roller[ 2 ] AS $rol ) { ?>
										<tr>
											<td><?php echo $sayi++; ?></td>
