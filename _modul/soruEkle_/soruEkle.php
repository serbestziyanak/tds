			...
			<div id="accordion">
				<div class="card card-secondary">
					...
					<form id = "kayit_formu" action = "_modul/crmMusteriPortfoy/crmMusteriPortfoySEG.php" method = "POST">
						<div id="collapseOne" class="collapse show <?php if( $_REQUEST[ 'islem'] == 'ekle' or $islem == 'guncelle' ) echo 'show';  ?>" data-parent="#accordion">
							<div class="card-body">
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											...
											<select  class="form-control" name = "ust_id" required>
											<option value="">Seçiniz...</option>
											<option value="0">Üst Kategori Yok</option>
											<?php
												function kategoriListele2( $categories, $ust_id, $parent = 0, $tab = 0 ){
													$html = '';
													...
													foreach ($categories as $category){
														if( $category['ust_id'] == $parent ){
															if( $parent == 0 ) $tab = 0;
															$secim = $category['id'] == $ust_id ? "selected" : "";
															$html .= "<option value='$category[id]' $secim>" . $tabekle. "&rarr; " . $category['adi']."</option>
															";
															$tab++;
															
															$html .= kategoriListele2($categories, $ust_id, $category['id'], $tab);
														}
													}
													return $html;
												}
