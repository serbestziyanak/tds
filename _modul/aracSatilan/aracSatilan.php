...
WHERE 
	a.aktif = 1 AND satis.dosya_kapatma = 1 AND satis.cayma_durumu = 2
AND
	CASE
		WHEN ? = 1 THEN TRUE
			...
			<div class="col-md-12">
				<div class="card card-success">
				  <div class="card-header">
					<h3 class="card-title"><i class="fas fa-hands-helping"></i> Satışı Yapılan Araçlar</h3>
					...
					<table id="example2" class="table table-sm table-bordered table-hover">
					  ...
					  <tbody>
						...
						<tr>
							...
							<td><span style="display:none;"><?php echo $arac[ 'satis_tarihi' ]; ?></span><?php echo date('d.m.Y H:i',strtotime($arac['satis_tarihi'])); ?></td>
							<td align = "center">
