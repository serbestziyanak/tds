...
$araclar				= $vt->select( $SQL_araclar, array( $_SESSION[ 'super' ]  ) );
...
<div class="modal fade" id="randevuAracAlanlar_sil_onay" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<script>
	$( '#randevuAracAlanlar_sil_onay' ).on( 'show.bs.modal', function( e ) {
          ...
          <div class="col-md-12">
			...
			<div id="accordion">
				<div class="card card-secondary">
					...
					<form id = "kayit_formu" action = "_modul/randevuAracAlanlar/randevuAracAlanlarSEG.php" method = "POST">
						<div id="collapseOne" class="collapse <?php if( $_REQUEST[ 'islem'] == 'ekle' or $islem == 'guncelle' ) echo 'show';  ?>" data-parent="#accordion">
							<div class="card-body">
								...
								<input type = "hidden" name = "randevu_tipi" value = "2">
								...
								<div class="row">
									<div class="col-md-4">
										...
										<div class="form-group">
											<label  class="control-label">Araç</label>
											<select  class="form-control select2" name = "arac_id" required>
													<option value="">Seçiniz</option>
												<?php foreach( $araclar[ 2 ] AS $arac ) { ?>
													<option value = "<?php echo $arac[ 'id' ]; ?>" <?php if( $arac[ 'id' ] ==  $randevu_bilgileri[ 'arac_id' ] ) echo 'selected'?>><?php echo $arac[ 'arac_no' ].' ('.$arac[ 'plaka' ].')'?></option>
												<?php } ?>
											</select>
										</div>
										<div class="form-group">
							...
							<div class="card-footer">
								<button modul= 'randevuAracAlanlar' yetki_islem="kaydet" type="submit" class="btn btn-success btn-sm pull-right"><span class="fa fa-save"></span> Kaydet</button>
								<a modul= 'randevuAracAlanlar'  yetki_islem="ekle" type="reset" class="btn btn-primary btn-sm pull-right" href = "?modul=randevuAracAlanlar&islem=ekle" ><span class="fa fa-plus"></span> Temizle / Yeni Kayıt</a>
							</div>
						</div>
					</form>
				</div>
		  ...
		  <div class="col-md-12">
            <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Araç Satın Almak İsteyenlerin Randevu Listesi</h3>
                ...
                <table id="example2" class="table table-sm table-bordered table-hover">
                  ...
                  <tbody>
					...
					<tr>
						...
						<td><b><?php echo $randevu[ 'arac_no' ]; ?><b></td>
						<td><?php echo $randevu[ 'arac_marka_adi' ]; ?></td>
						<td><?php echo $randevu[ 'ticari_adi' ]; ?></td>
						...
						<td align = "center">
						  <a modul = 'randevuAracAlanlar' yetki_islem="duzenle" class = "btn btn-sm btn-warning btn-xs" href = "?modul=randevuAracAlanlar&islem=guncelle&id=<?php echo $randevu[ 'id' ]; ?>" >
							Düzenle
						  </a>
						</td>
						<td align = "center">
							<button modul= 'randevuAracAlanlar' yetki_islem="sil" class="btn btn-sm btn-danger btn-xs" data-href="_modul/randevuAracAlanlar/randevuAracAlanlarSEG.php?islem=sil&id=<?php echo $randevu[ 'id' ]; ?>" data-toggle="modal" data-target="#randevuAracAlanlar_sil_onay" >Sil</button>
						</td>
					</tr>
					<?php } ?>
                  </tbody>
