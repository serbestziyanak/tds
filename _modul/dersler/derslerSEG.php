...
$SQL_ekle			= "INSERT INTO tb_dersler SET ";
$SQL_guncelle 		= "UPDATE tb_dersler SET ";


foreach( $_REQUEST as $alan => $deger ) {
	if( $alan == 'islem' or  $alan == 'PHPSESSID' or  $alan == 'ders_id') continue;
		$alanlar[]		= $alan;
		$degerler[]		= $deger;
}
...
if( $islem == 'guncelle' ) $degerler[] = $ders_id;
...
$_SESSION[ 'sonuclar' ][ 'id' ] = $ders_id;
header( "Location:../../index.php?modul=dersler&islem=guncelle&ders_id=".$ders_id );
?>